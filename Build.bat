...
pushd .\Build\
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% ../../HandmadeHero/Source/handmade.cpp -Fmhandmade.map -LD /link -incremental:no -PDB:handmade_%time:~0,2%%time:~3,2%%time:~6,2%.pdb -EXPORT:GameUpdateAndRender -EXPORT:GameGetSoundSamples
